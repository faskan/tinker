...
* The original package name 'be.techroots.gcloud-run' is invalid and this project uses 'be.techroots.gcloudrun' instead.
...
```
$ docker run --rm -p 8080:8080 gcloud-run:0.0.1-SNAPSHOT
```
...
mvn spring-boot:build-image -Pnative -Dspring-boot.build-image.imageName=us.gcr.io/<projectid>/spring-boot-v3-hello

docker push us.gcr.io/<projectid>/spring-boot-v3-hello

gcloud run deploy spring-boot-v3-hello-world --image us.gcr.io/<projectid>/spring-boot-v3-hello
